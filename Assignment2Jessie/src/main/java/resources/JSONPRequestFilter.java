...
public class JSONPRequestFilter implements Filter {
    ...
    public void init(FilterConfig config) throws ServletException {
        //Nothing needed
    	System.out.println("JSONPRequestFilter.java init(FilterConfig config)");
    }

    @Override
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
            ServletException {
    	System.out.println("JSONPRequestFilter.java doFilter(ServletRequest request, ServletResponse response, FilterChain chain)");
    ...
    private String getCallbackMethod(HttpServletRequest httpRequest) {
    	System.out.println("JSONPRequestFilter.java getCallbackMethod(HttpServletRequest httpRequest)");
    ...
    private boolean isJSONPRequest(String callbackMethod) {
    	...
    	System.out.println("JSONPRequestFilter.java isJSONPRequest(String callbackMethod)");
    ...
    public void destroy() {
        //Nothing to do
    	System.out.println("JSONPRequestFilter.java destroy()");
    }
}